classdef LabMicroscopiaApp < matlab.apps.AppBase
    ...
    try
        app.Version = '2024';  % Ano fixo da versão
        app.UpdateDate = string(datetime('now', 'Format', 'yyyy-MM-dd'));
        createComponents(app);

        % Registro de uso atualizado
        disp(['Aplicativo iniciado por: ', 'Altiort']);
        disp(['Data e hora de início: ', string(datetime('now', 'Format', 'yyyy-MM-dd HH:mm:ss'))]);
